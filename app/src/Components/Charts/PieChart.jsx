...
const AXIS_SETTINGS = { showXAxis: false, showYAxis: false, XAxisAccessor: 'name' }
const TOOLTIP_SETTINGS = { showTooltip: false };
const SIZES_SETTINGS = { width: 200, height: 50, responsive: false }
const CUSTOMIZATIONS_SETTINGS = { borderTop: false, borderBottom: false, borderRight: false, borderLeft: false, borderColor: '#222' }

const FINAL_OPTIONS = { ...AXIS_SETTINGS, ...TOOLTIP_SETTINGS, ...SIZES_SETTINGS, ...CUSTOMIZATIONS_SETTINGS };

const CustomPieChart = ({ data, accessor, fillColor, strokeColor, options = { ...FINAL_OPTIONS } }) => {
